...
import static com.example.ProiectPlayerAudio.R.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butonX = (ImageButton) findViewById(id.butonX);
        butonX.setOnClickListener(view -> {
            moveTaskToBack(true);
        ...
        noMusicTextView = findViewById(id.no_songs_text);
